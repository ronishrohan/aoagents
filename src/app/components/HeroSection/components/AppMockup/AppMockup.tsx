...
export function AppMockup({ activeDemo = "Use Any Agents" }: AppMockupProps) {
	return (
		<div
			className="relative w-full min-w-[700px] overflow-hidden rounded-xl border border-border bg-background shadow-[0_30px_80px_-24px_rgba(0,0,0,0.7)]"
			style={{ aspectRatio: "16/10" }}
		>
			<div className="pointer-events-none absolute inset-0 z-20 rounded-xl ring-1 ring-inset ring-white/[0.04]" />
